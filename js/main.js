...
d3.csv("data/flights-datetime.csv", function(flights) {
  ...
  /*********** group flights count by hour by day of week starts **************/

  var flightsDelaysByHourDay = d3.nest()
  ...
  //returns a list of objects containing values
  for (var i = 0; i < flightsDelaysByHourDay.length; i++){
    flightsDelaysByHourDay[i] = flightsDelaysByHourDay[i].values;
  }

  /*********** group flights count by hour by day of week ends **************/
